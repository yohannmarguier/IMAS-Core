...
extern "C"
{
  ...
  */
  ...
  /**
     ...
     flexbuffers ignore the call entirely, memory implements node and subtree
     deletes but not the DATAOBJECT one, MDSplus implements node deletes only.
     HDF5 implements all three. The per-backend matrix, and why the argument is
     specified this way rather than as an occurrence-wide delete, are recorded
     in docs/adr/0001-al-delete-data-path-semantics.md.
